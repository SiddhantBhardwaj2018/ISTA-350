...
class Node:
    def __init__(self,data):
        ...
        and the instance variable left anf right to None.
        '''
        self.datum = data
        self.left = None
        self.right = None
    ...
    def __add__(self,value):
        '''
        This magic method inserts a new item with self as a root, if the item
    ...
    def __contains__(self,item):
        '''
        This magic method takes an item and returns True if it is in the subtree, else returns
        False
        '''
        if self:
...
class BST:
    def __init__(self,item = None):
        '''
        This constructor takes an item with the default value of None
        and sets self.root to None if item is None else sets it to Node of item.
        '''
        if item:
            self.root = Node(item)
        else:
    ...
    def __contains__(self,item):
        '''
        This magic method takes an item and returns True if item in self
        else returns False
        '''
        if self:
            if self.root:
    ...
    def from_file(cls,fname,type1 = None):
        '''
        This class method takes a filename and a type argument which defaults to None.
        It initializes BST tree and reads the file, stripping it and adds it to the Tree
        in the type as is required in the type argument. If type argument is None, it 
        adds to the tree as it is.
        '''
        tree = cls()
...
def selection_sort(lst):
    '''
    This function applies the selection algorithm to a list of unordered numbers and returns an
    ordered list.
    '''
